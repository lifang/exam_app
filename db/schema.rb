...
ActiveRecord::Schema.define(:version => 20110524092130) do
  ...
  add_index "question_tag_relations", ["question_point_id"], :name => "index_question_tag_relations_on_question_point_id"
