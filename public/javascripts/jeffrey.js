...
function create_question(id){
    if (close_question_info_id != 0) document.getElementById("question_info_"+close_question_info_id).style.display="none";
    ...
    function change_info(){
        if (close_question_info_id != 0) document.getElementById("question_info_"+close_question_info_id).style.display="none";
        if (close_create_question_id != 0) document.getElementById("create_question_"+close_create_question_id).style.display="none";
